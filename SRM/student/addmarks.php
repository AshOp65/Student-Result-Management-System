...
<body>
    <header>
      ...
      <div class="main-content-header">
        ...
        <form method="post" enctype="multipart/form-data" action="second.php">
            <table class="table1">
             <tr>
                <th>Name </th>  
                 <th> Class</th> 
             ...
             <tr>
                 ...
                 <td> <select class="box" name="class">
                                <option value="" selected disabled>Choose your class</option>
         ...
         <table class="table3">
           <tr>
               <th>Choose Image -</th>
               <td><input type="file" name="img" required/ onchange="loadFile(event)">
               <img id="frame" src="" width="100px" height="100px" alt="Preview  image"/></td>
           </tr> 
         </table>
         <table class="table4">
            <tr>
